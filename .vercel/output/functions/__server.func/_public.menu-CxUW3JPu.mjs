...
function MenuPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-32 text-center text-muted-foreground", children: "Yüklənir…" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MenuSection, {}) })
  ] });
}
export {
